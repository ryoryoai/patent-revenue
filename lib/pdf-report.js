...
async function generateReportPdf(data) {
  ...
  try {
    ...
    const pdfBuffer = await page.pdf({
      ...
      margin: { top: "18mm", bottom: "15mm", left: "0mm", right: "0mm" },
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .page-header-repeat .brand { font-size: 8pt; font-weight: 700; color: #fff; letter-spacing: 0.05em; }
  .page-header-repeat .label { font-size: 7pt; color: rgba(255,255,255,0.7); }
...
<div class="page-header-repeat">
  <span class="brand">PatentRevenue</span>
  <span class="label">特許詳細評価レポート</span>
</div>
