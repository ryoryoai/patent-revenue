...
<div style="max-width:600px;margin:0 auto;padding:24px 16px 40px;">
  ...
  <div style="background:#ffffff;border-radius:8px;border:1px solid rgba(51,71,142,0.15);box-shadow:0 2px 8px rgba(0,0,0,0.06);padding:28px 24px;margin-bottom:16px;">
    ...
    <p style="margin:0 0 16px;font-size:14px;color:#555;line-height:1.8;">より詳細な分析を行った「詳細評価レポート」もご利用いただけます。</p>
    <p style="margin:0 0 16px;font-size:14px;color:#555;line-height:1.8;">診断結果ページの「詳細レポートを申請する」ボタンから、追加情報を入力してお申し込みください。AIによる詳細評価レポートをメールでお届けします。</p>
  </div>
