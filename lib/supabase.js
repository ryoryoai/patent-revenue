 ...
 */
async function saveLead({ name, companyName, email, source = "patent-value-analyzer", referrer = null, utmData = null, landingPage = null }) {
...
module.exports = { saveLead, savePatent, updateLeadStatus, findLeadByEmail, saveDetailedReportRequest, getSupabase };
